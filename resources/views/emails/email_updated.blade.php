...
<head>
    ...
    <title>E-posta Değiştirme</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>E-posta adresinizi değiştirme isteğiniz alındı.</p>
            <p>E-posta adresinizi değiştirmek için aşağıdaki bağlantıya tıklayın:</p>
            ...
            <p style="margin-top: 20px;">
                <a href="{{ $verificationUrl }}" 
                    ...
                    border-radius: 5px;
                    text-decoration: none;
                    font-size: 14px;">Değiştirmek için tıkla
                </a>
            </p>
        </div>
        <div class="email-footer">
            <p>Bu e-posta yalnızca e-posta adresinizi değiştirmek istediğiniz zaman gönderilir. Bu işlemi siz başlatmadıysanız lütfen bizimle iletişime geçin.</p>
